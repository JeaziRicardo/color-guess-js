# :art: Projeto Adivinhe a Cor

## :scroll: Sobre

<details>

O projeto **Color Guess** foi executado como requisito obrigatório do curso de Desenvolvimento Web da [Trybe](https://www.betrybe.com/). Foi um dos primeiros projetos realizados do módulo de fundamentos, onde a interface trás os números que formam uma cor RGB aleatória e o usuário precisa selecionar, dentre seis opções, a cor que os números RGB formam.

> :eyes: Observação: existem melhorias para serem feitas no projeto, mas optei em deixar assim para acompanhar minha evolução quando comparados a outros projetos.
...
|![Imagem do progresso do projeto](/img/progress-color-guess.png)|
|:--:|
...
|![Imagem da aplicação](/img/color-guess.png)|
|:--:|
...
```sh
git clone git@github.com:JeaziRicardo/color-guess-js.git
```
